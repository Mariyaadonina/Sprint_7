...
class TestCreateOrder:
    ...
    def test_successful_create_order_code(self, order_body, new_couriers_and_clear_courier_data, cancel_order_fixture):
    ...
    @pytest.mark.parametrize('order_body',
                             [TestOrderData.ORDER_BODY_BLACK, TestOrderData.ORDER_BODY_GREY,
                              TestOrderData.ORDER_BODY_BLACK_GREY, TestOrderData.ORDER_BODY_NO_COLOUR])
    def test_successful_create_order_message(self, order_body, new_couriers_and_clear_courier_data, cancel_order_fixture):
